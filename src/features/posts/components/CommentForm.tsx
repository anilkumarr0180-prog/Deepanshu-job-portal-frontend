    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5" noValidate>
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 space-y-1 min-w-0">
          <label htmlFor={`comment-content-${postId}`} className="sr-only">
            Write a comment
          </label>
          <textarea
            ...
            placeholder="Write a constructive comment... (Ctrl+Enter to post)"
            disabled={isPending}
