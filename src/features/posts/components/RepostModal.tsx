          ...
          {isQuoteMode ? (
            <div className="space-y-2">
              ...
              <textarea
                ...
                maxLength={5000}
                autoFocus
                className="w-full resize-none rounded-xl border border-slate-200 p-3 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:border-[#3C65F5] focus:ring-2 focus:ring-[#3C65F5]/20 focus:outline-none transition"
              />
          ...
          {!isQuoteMode ? (
            <>
              <button
                ...
                disabled={isPending}
                className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-bold text-slate-700 shadow-2xs hover:bg-slate-50 hover:border-slate-300 transition"
              >
              ...
              <button
                ...
                disabled={isPending}
                className="inline-flex items-center gap-1.5 rounded-xl bg-[#3C65F5] px-4 py-2 text-xs font-bold text-white shadow-xs hover:bg-[#3457D5] transition disabled:opacity-50"
              >
                {isPending ? (
            ...
            <>
              <button
                ...
                disabled={isPending}
                className="rounded-xl px-3 py-2 text-xs font-semibold text-slate-500 hover:text-slate-800 transition"
              >
                Back
              </button>
